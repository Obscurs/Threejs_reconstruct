...
export class VRGUIPhoto extends UIElement{
	constructor(pathImage, index, camInfo, offset_x, offset_y, offset_z) {
		...
		function testFun3(p1, p2) { APPLICATION.showZoomedPhoto(self.imageIndex)}
		this.button1 = new VRGUIButton(testFun3, "BUTTON OPEN")
		...
		function testFun(p1, p2) { APPLICATION.changeCaptureInView(self.imageIndex)}
		this.button2 = new VRGUIButton(testFun, "BUTTON PROJECT")
		...
		function testFun2(p1, p2) { APPLICATION.moveToCapturePosition(self.imageIndex)}
		this.button3 = new VRGUIButton(testFun2, "BUTTON TELEPORT")
		...
		this.button4 = new VRGUIButton(null, "BUTTON COLLECTION")
